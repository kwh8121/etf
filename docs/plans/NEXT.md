...
- [ ] `DECIDE` Q-06 US 07:30 timer의 근무시간대 재편
  - 선택지: A. 근무시간대 자동 발화로 지연 허용 / B. 현 timer 유지 후 다음 기동 따라잡기 관측
  - 권장: A. 실제 운영 가능한 시간대에 맞추되 정확한 시각과 보고 지연 허용치를 먼저 확정
...
- [ ] `DECIDE` Q-09 M5-A 순설정·환매 추정 착수 및 임계값
  - 선택지: A. M6 관측 이후 근거를 모아 설계·착수 / B. M6와 병행해 실험 설계 착수
  - 권장: A. ROADMAP의 임계값 조정 유보 원칙과 운영 관측 우선순위를 유지
