...
- 현재 현황·재개 기준: `docs/plans/implementation/`, `docs/guides/etf-signal-mvp-e2e-configuration-guide.md`, `docs/guides/etf-signal-mvp-m6-observation-runbook.md`, `docs/guides/etf-signal-mvp-continuity-harness.md`, `docs/guides/etf-signal-mvp-omc-development-flow.md`(OMC 활용 개발 흐름), `docs/jobs/2026-09-22-etf-signal-mvp-kr-누락일-보충-작업기록.md`
